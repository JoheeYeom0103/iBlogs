...
include('EditAccountPage_Action.php');
...
<head>
    ...
    <!-- Embeded script to deal with dynamical display of new image -->
    <script>
...
<body>
    ...
    <div id="profile-details">
        ...
        <form method="post" action="" id="profile-form" class="user-profile" enctype="multipart/form-data">
            ...
            <div id="buttons">
                <button type="button" class="buttons" name="cancel" onclick="if(confirm('Are you sure?')) { window.location.href='editaccountpage.php'; }">Cancel</button>
